    ...
    <div style={{ display: "flex", minHeight: "100vh", background: colors.bg }}>
      <aside style={{
        ...
        <nav style={{ flex: 1, display: "flex", flexDirection: "column", gap: 4 }}>
          <NavItem to="/eleve" end label="Tableau de bord" colors={colors} />
          <NavItem to="/eleve/emploi-du-temps" label="Emploi du temps" colors={colors} />
          <NavItem to="/eleve/presences" label="Mes presences" colors={colors} />
          <NavItem to="/eleve/paiements" label="Mes paiements" colors={colors} />
        </nav>
