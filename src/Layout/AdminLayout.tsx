...
const navItems: NavItem[] = [
  ...
  { to: "/activite", labelKey: "activite" as TranslationKey, icon: "logs", roles: ["admin", "gestionnaire"] },
  { to: "/ia", labelKey: "ia" as TranslationKey, icon: "brain", roles: ["admin", "gestionnaire"] },
  { to: "/sauvegarde", labelKey: "sauvegarde" as TranslationKey, icon: "backup", roles: ["admin"] },
...
const icons: Record<string, React.ReactNode> = {
  ...
  logs: <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M7 5H17M7 10H17M7 15H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/><circle cx="3.5" cy="5" r="1" fill="currentColor"/><circle cx="3.5" cy="10" r="1" fill="currentColor"/><circle cx="3.5" cy="15" r="1" fill="currentColor"/></svg>,
  brain: <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M7 3C5.3 3 4 4.3 4 6c0 .7.2 1.4.6 1.9C3.6 8.4 3 9.6 3 11c0 2.2 1.8 4 4 4h1v1a1 1 0 002 0v-1h1c2.2 0 4-1.8 4-4 0-1.4-.6-2.6-1.6-3.1.4-.5.6-1.2.6-1.9 0-1.7-1.3-3-3-3-.5 0-1 .1-1.4.4A3 3 0 007 3Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/><path d="M10 7v8M7.5 9.5c0 0 .5-1 2.5-1s2.5 1 2.5 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>,
  backup: <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M14 10a4 4 0 10-8 0M10 6V2M7.5 4.5L10 2l2.5 2.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M3 14h14M6 17h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>,
