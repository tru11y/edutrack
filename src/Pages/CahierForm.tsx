    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: 400 }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ width: 40, height: 40, border: "3px solid #e2e8f0", borderTopColor: isProf ? "#10b981" : "#8b5cf6", borderRadius: "50%", animation: "spin 0.8s linear infinite", margin: "0 auto 16px" }} />
  ...
  return (
    <div>
      <div style={{ marginBottom: 32 }}>
        <Link to="/cahier" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#64748b", textDecoration: "none", fontSize: 14, marginBottom: 16 }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 24 }}>
            <div>
              ...
              <input type="date" name="date" value={form.date} onChange={handleChange} style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: 10, fontSize: 14, boxSizing: "border-box" }} />
            </div>
            <div>
              <label style={{ display: "block", fontSize: 13, fontWeight: 500, color: "#64748b", marginBottom: 8 }}>Classe *</label>
              <select name="classe" value={form.classe} onChange={handleChange} style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: 10, fontSize: 14, background: "#fff", boxSizing: "border-box" }}>
          ...
          {form.classe && (
            <div style={{ padding: 16, background: "#f8fafc", borderRadius: 10, marginBottom: 24 }}>
              <p style={{ margin: "0 0 12px", fontSize: 14, fontWeight: 500, color: "#1e293b" }}>
                {elevesClasse.length} eleve{elevesClasse.length > 1 ? "s" : ""} dans cette classe
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {elevesClasse.map((eleve) => (
                  <span key={eleve.id} style={{ padding: "6px 12px", background: eleve.sexe === "M" ? "#dbeafe" : "#fce7f3", color: eleve.sexe === "M" ? "#3b82f6" : "#ec4899", borderRadius: 8, fontSize: 13, fontWeight: 500 }}>
          ...
          <div style={{ marginBottom: 24 }}>
            <label style={{ display: "block", fontSize: 13, fontWeight: 500, color: "#64748b", marginBottom: 8 }}>Contenu du cours</label>
            <textarea name="contenu" value={form.contenu} onChange={handleChange} rows={5} placeholder="Decrivez le contenu du cours..." style={{ width: "100%", padding: "12px 14px", border: "1px solid #e2e8f0", borderRadius: 10, fontSize: 14, boxSizing: "border-box", resize: "vertical", fontFamily: "inherit" }} />
          </div>

          <div style={{ marginBottom: 24 }}>
            <label style={{ display: "block", fontSize: 13, fontWeight: 500, color: "#64748b", marginBottom: 8 }}>Devoirs</label>
            <textarea name="devoirs" value={form.devoirs} onChange={handleChange} rows={4} placeholder="Devoirs a faire pour la prochaine fois..." style={{ width: "100%", padding: "12px 14px", border: "1px solid #fde68a", borderRadius: 10, fontSize: 14, boxSizing: "border-box", resize: "vertical", fontFamily: "inherit", background: "#fffbeb" }} />
          </div>
