...
export default function ElevePresences() {
  ...
  if (history.length === 0)
    return <div className="p-6" style={{ color: colors.textMuted }}>Aucune présence enregistrée</div>;

  return (
    <div className="p-6">
      <h1 className="text-xl font-bold mb-4" style={{ color: colors.text }}>📋 Mes présences</h1>
